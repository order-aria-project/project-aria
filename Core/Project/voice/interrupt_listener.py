...
class InterruptListener:
    ...
    Stability-focused behavior:
    - Reuses one Vosk interruption recognizer instead of rebuilding the
      interruption grammar every time ARIA speaks.
    - Requires a high-confidence interruption phrase before stopping TTS.
    - Does not affect the main wake-word or command speech pipeline.
    """

    # Conservative threshold: a marginal Vosk match should not interrupt
    # speech, singing, music, or background audio.
    ...
    def __init__(
        ...
        self.stream = None
        self.recognizer: Optional[KaldiRecognizer] = (
    ...
    def _confidence_for_phrase(
        ...
        for entry in entries:
            ...
            if word:
                recognized.append((word, confidence))
    ...
    def _listen_loop(self) -> None:
        try:
            ...
            while (
                ...
                print(
                    f"[BARGE] '{phrase}' confidence={confidence:.2f}",
                    flush=True,
                )
